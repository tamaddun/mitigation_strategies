...
landscape1 = Image.open("./Images/landscape1.png").convert("RGBA")
landscape2 = Image.open("./Images/landscape2.png").convert("RGBA")
facility1 = Image.open("./Images/facility1.png").convert("RGBA")
facility2 = Image.open("./Images/facility2.png").convert("RGBA")
...
engine = Image.open("./Images/engine.png").convert("RGBA")
wheels = Image.open("./Images/wheels.png").convert("RGBA")
...
sun = Image.open("./Images/sun.png").convert("RGBA")
frame = Image.open("./Images/frame.png").convert("RGBA")
text = Image.open("./Images/texts.png").convert("RGBA")
